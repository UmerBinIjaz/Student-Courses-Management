 <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <div class="sidebar-heading">
       ...
       <li class="nav-item">
        ...
        <div id="collapseClass" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          ...
          <!-- <h6 class='collapse-header'>ddddzfd</h6> -->
            <!-- \"Teacher/index.php?id=" . $rows['Id'] . "\" -->
            <a class="collapse-item" href="AddCourses.php?id=<?php echo $_GET['id']; ?>">Registerd Courses</a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#CheckAttendance"
          aria-expanded="true" aria-controls="CheckAttendance">
          <i class="fas fa-user-graduate"></i>
          <span>Manage Attendance</span>
        </a>
        <div id="CheckAttendance" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
          <!-- <h6 class='collapse-header'>ddddzfd</h6> -->
            <!-- \"Teacher/index.php?id=" . $rows['Id'] . "\" -->
            <a class="collapse-item" href="CheckAttendance.php?id=<?php echo $_GET['id']; ?>">CheckAttendance</a>
            <!-- <a class="collapse-item" href="#">Assets Type</a> -->
          </div>
        </div>
      </li>
