 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        ...
        if(isset($_POST['update'])){
            ...
            $query=mysqli_query($conn,"update tblcourse set courseName='$courseName' where Id='$Id'");
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="courseName" value="<?php echo $row['courseName'];?>" id="exampleInputFirstName" placeholder="Class Name">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
