...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($ret > 0) {
        ...
        $sqlquery = mysqli_query($conn, "INSERT INTO tblstudent (reg, name, password, dateCreated) 
        VALUES ('$reg', '$name', '$HashPass', '$dateCreated')");
        

        if ($sqlquery) {
            $statusMsg = "<div class='alert alert-success' style='margin-right:700px;'>Created Successfully!</div>";
            // $qu = mysqli_query($conn, "UPDATE tblstudent SET isAssigned='1' WHERE Id ='$teacherId'");
...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit") {
    ...
    $que = mysqli_query($conn, "SELECT * FROM tblstudent WHERE Id ='$Id'");
    ...
    if (isset($_POST['update'])) {
        ...
        $que = mysqli_query($conn, "UPDATE tblstudent SET name ='$name',  password='$HashPass' where Id='$Id'");
...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "delete")
{
      ...
      $q = mysqli_query($conn,"DELETE FROM tblstudent WHERE Id='$Id'");
                ...
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Email/Reg Id<span class="text-danger ml-2">*</span></label>
                      <input type="email" class="form-control" required name="reg" value="<?php echo $row['reg'];?>" id="exampleInputFirstName" >
                        </div>
                    </div>
                     <div class="form-group row mb-3">
                        <div class="col-xl-6">
